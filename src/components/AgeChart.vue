  ...
  <div :id="`${this.idTitle}Chart`">
    <div class="containing">
      ...
      <div
        ...
        class="icon icon-downloadimg icon-sm icon-downloadimg-abs mb-2"
        :class="{ active: false }"
        @click="downloadImageAge"
      >
      ...
      <div
        ...
        class="icon icon-downloaddoc icon-sm icon-downloaddoc-abs mb-2"
        :class="{ active: false }"
        @click="showTosModalCsvAge"
      >
    ...
    >
      ...
      <template #modal-footer>
        ...
        <b-button variant="danger" @click="acceptTermsAge"> I Accept </b-button>
        <b-button variant="danger" @click="rejectTermsAge">
          I Do Not Accept
        </b-button>
      </template>
    </b-modal>
...
export default defineComponent({
  ...
  data() {
    return {
      ...
      showMarket: false,
      showLogo: false,
      // highlightChartUrban: this.highlightChartUrban,
      // highlightChartSubUrban: this.highlightChartSubUrban,
      // highlightChartExUrban: this.highlightChartExUrban,
      // defaultUrbanBackgroundColor: "#660000",
      // defaultSubUrbanBackgroundColor: "#990001",
      // defaultExUrbanBadkgroundColor: "#CC0000",
      // urbanBackgroundColor: "#660000",
      // subUrbanBackgroundColor: "#990001",
      // exUrbanBadkgroundColor: "#CC0000",
    };
  },
  created() {},
  ...
  computed: {
    ...
    computedChartData() {
      ...
      let returnData = {
        labels: [["Age: 18-44"], ["Age: 45-64"], ["Age: 65+"]],
  ...
  methods: {
    showTosModalCsvAge() {
      ...
      this.$bvModal.show("modal-tos-age");
    },
    showTosModalImageAge() {
      // this.$refs[].show()
      this.downloadRequestFunction = "downloadImageAge";
      this.$bvModal.show("modal-tos-age");
    },
    acceptTermsAge() {
      // this.$refs[].show()
      this.$bvModal.hide("modal-tos-age");
      // console.log('accept')
      this.tosAccepted = true;
      if (this.downloadRequestFunction == "downloadDataCsv") {
        this.downloadDataCsv();
      } else if (this.downloadRequestFunction == "downloadImageAge") {
        this.downloadImageAge();
      }
    ...
    async downloadImageAge() {
      ...
      html2canvas(document.querySelector(`#${this.idTitle}Chart canvas`), {
        ...
        (chartCanvas) => {
          html2canvas(document.querySelector("#ageChartTitle"), {
            backgroundColor: null,
            useCORS: true,
            allowTaint: true,
          }).then((mapTitle) => {
            html2canvas(document.querySelector("#ageChartLogo"), {
              backgroundColor: null,
              useCORS: true,
              allowTaint: true,
            }).then((logo) => {
