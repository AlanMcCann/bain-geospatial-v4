import { FlowmapLayer } from '../layers';
...
export const UI_INITIAL = {
  ...
  opacity: 1.0,
  fadeEnabled: true, //FlowmapLayer.defaultProps.fadeEnabled,
  fadeOpacityEnabled: FlowmapLayer.defaultProps.fadeOpacityEnabled,
  fadeAmount: FlowmapLayer.defaultProps.fadeAmount,
  clusteringEnabled: false, //FlowmapLayer.defaultProps.clusteringEnabled,
  ...
  showFlowLines: FlowmapLayer.defaultProps.showFlowLines,
};
...
export const initLilGui = (gui) => {
  ...
  gui.add(UI_INITIAL, 'showFlowLines');
